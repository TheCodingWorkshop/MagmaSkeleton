 ...
 * protected constant
 */
class TimesheetActionSubscriber implements EventSubscriberInterface
{
     ...
     *
     * @param TimesheetActionEvent $event
     * @return void
     * @throws Exception
     */
    public function flashEvent(TimesheetActionEvent $event)
    {
