...
use App\Event\EmployeeActionEvent;
use Exception;
 ...
 * protected constant
 */
class EmployeeActionSubscriber implements EventSubscriberInterface
{
     ...
     * @throws Exception
     */
    public function flashMessageEvent(EmployeeActionEvent $event)
    {
