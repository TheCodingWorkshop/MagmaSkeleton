 ...
 * protected constant
 */
class BranchActionSubscriber implements EventSubscriberInterface
{
     ...
     *
     * @param BranchActionEvent $event
     * @return void
     * @throws Exception
     */
    public function flashEvent(BranchActionEvent $event)
    {
