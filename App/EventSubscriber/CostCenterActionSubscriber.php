 ...
 * protected constant
 */
class CostCenterActionSubscriber implements EventSubscriberInterface
{
    ...
    {
        return [
            CostCenterActionEvent::NAME => [
                ['flashEvent', self::FLASH_MESSAGE_PRIORITY],
            ]
        ];
    }
     ...
     *
     * @param CostCenterActionEvent $event
     * @return void
     * @throws Exception
     */
    public function flashEvent(CostCenterActionEvent $event)
    {
