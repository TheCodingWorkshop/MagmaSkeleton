 ...
 * protected constant
 */
class HolidayActionSubscriber implements EventSubscriberInterface
{
     ...
     *
     * @param HolidayActionEvent $event
     * @return void
     * @throws Exception
     */
    public function flashEvent(HolidayActionEvent $event)
    {
