...
class LeaveTypeModel extends AbstractBaseModel
{

    /** @var string */
    protected const TABLESCHEMA = 'leave_types';
    /** @var string */
    ...
    {
        parent::__construct(self::TABLESCHEMA, self::TABLESCHEMAID, LeaveTypeEntity::class);
    }
    ...
    {
        $name = $this->getRepo()->findObjectBy(['id' => $id], ['leave_type']);
        return $name->leave_type;
    }
