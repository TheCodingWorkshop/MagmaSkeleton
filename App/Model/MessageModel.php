...
class MessageModel extends AbstractBaseModel
{

    /** @var string */
    protected const TABLESCHEMA = 'messages';
    /** @var string */
    ...
    {
        parent::__construct(self::TABLESCHEMA, self::TABLESCHEMAID, MessageEntity::class);
    }
