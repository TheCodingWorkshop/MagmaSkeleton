...
class EmployeeModel extends AbstractBaseModel
{
    ...
    /** @var string */
    protected const TABLESCHEMA = 'employees';
    /** @var string */
    ...
    {
        parent::__construct(self::TABLESCHEMA, self::TABLESCHEMAID, EmpoyeeEntity::class);
    }
    ...
    {
        $name = $this->getRepo()->findObjectBy(['id' => $id], ['employee_name']);
