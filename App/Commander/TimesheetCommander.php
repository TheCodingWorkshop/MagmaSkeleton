...
class TimesheetCommander extends TimesheetModel implements ApplicationCommanderInterface
{
    ...
    public function getHeaderBuild(object $controller): string
    {
        ...
        return match ($controller->thisRouteAction()) {
            ...
            'import' => 'Import',
            'export' => 'Export',
            'edit' => "Edit [" . $this->getHeaderBuildEdit($controller, 'project') . ']',
            default => "Unknown"
        };
    }
}
