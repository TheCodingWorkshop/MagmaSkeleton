...
class LeaveTypeCommander extends LeaveTypeModel implements ApplicationCommanderInterface
{
    ...
    public function getHeaderBuild(object $controller): string
    {
        ...
        return match ($controller->thisRouteAction()) {
            ...
            'import' => 'Import',
            'export' => 'Export',
            'edit' => "Edit [" . $this->getHeaderBuildEdit($controller, 'leave_type') . ']',
            default => "Unknown"
        };
    }
}
