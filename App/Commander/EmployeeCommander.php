...
class EmployeeCommander extends EmployeeModel implements ApplicationCommanderInterface
{
    ...
    public function getHeaderBuild(object $controller): string
    {
        ...
        return match ($controller->thisRouteAction()) {
            ...
            'new' => 'Employee',
            'edit' => "Edit [" . $this->getHeaderBuildEdit($controller, 'employee_name') . ']',
            default => "Unknown"
        };
    }
}
