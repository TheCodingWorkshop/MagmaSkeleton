...
class ProjectColumn extends AbstractDatatableColumn
{
    ...
    private string $controller = 'project';
        ...
        return [
            ...
            [
                ...
                'formatter' => function ($row, $tempExt) {
                    ...
                    $html .= '<a href="' . ($isActive ? '/admin/project/' . $row['id'] . '/deactive' : '/admin/project/' . $row['id'] . '/active') . '">';
                    $html .= '<span uk-tooltip="' . ($isActive ? 'Click to De-activate project' : 'Click to Activate project') . '">' . ($isActive ? '<ion-icon name="checkmark-outline"></ion-icon>' : '<ion-icon name="close-outline"></ion-icon>') . '</span>';
                    $html .= '</a>';
                    $html .= '</span>';
                    $html .= '<div>';
                    $html .= '</div>';
