...
class LeaveTypeColumn extends AbstractDatatableColumn
{
    ...
    private string $controller = 'leave';

    public function __construct(LeaveTypeModel $leaveTypeModel)
    {
        ...
        return [
            [
                ...
                'formatter' => function ($row) {
                    return '<input type="checkbox" class="uk-checkbox" id="leaves-' . $row['id'] . '" name="id[]" value="' . $row['id'] . '">';
                }
            ],
            [
                'db_row' => 'leave_type',
            ...
            [
                ...
                'formatter' => function ($row, $tempExt) {
                    return $tempExt->action(
                        ...
                        false,
                        'Are You Sure!',
                        "You are about to carry out an irreversable action. Are you sure you want to delete <strong class=\"uk-text-danger\">{$row['leave_type']}</strong> category."
                    );
                }
            ],
