...
use App\Forms\Admin\Employee\EmployeeForm;
use App\Model\EmployeeModel;
use MagmaCore\Datatable\AbstractDatatableColumn;
use MagmaCore\Datatable\DataColumnTrait;

class EmployeeColumn extends AbstractDatatableColumn
{

    use DataColumnTrait;

    private EmployeeModel $categoryModel;
    private EmployeeForm $form;

    private string $controller = 'category';

    public function __construct(EmployeeModel $employeeModel, EmployeeForm $form)
    {
