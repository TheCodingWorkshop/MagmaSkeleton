...
class TimesheetSchema implements DataSchemaBuilderInterface
{
    ...
    protected object $timesheetModel
    ;
     ...
     * @return void
     */
    public function __construct(DataSchema $schema, DataSchemaBlueprint $blueprint, TimesheetModel $timesheetModel)
    {
        $this->schema = $schema;
