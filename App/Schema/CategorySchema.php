...
class CategorySchema implements DataSchemaBuilderInterface
{
    ...
    protected object $categoryModel
    ;
     ...
     * @return void
     */
    public function __construct(DataSchema $schema, DataSchemaBlueprint $blueprint, CategoryModel $categoryModel)
    {
        $this->schema = $schema;
    ...
    public function createSchema(): string
    {
        return $this->schema
            ->schema()
            ->table($this->categoryModel)
            ->row($this->blueprint->autoID())
            ->row($this->blueprint->varchar('cat_name', 100))
            ->row($this->blueprint->varchar('cat_slug', 100))
            ->row($this->blueprint->longtext('cat_description'))
            ->row($this->blueprint->int('cat_parent', 10))
