...
class HolidaySchema implements DataSchemaBuilderInterface
{
     ...
     * @return void
     */
    public function __construct(DataSchema $schema, DataSchemaBlueprint $blueprint, HolidayModel $holidayModel)
    {
        $this->schema = $schema;
