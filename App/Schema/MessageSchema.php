...
class MessageSchema implements DataSchemaBuilderInterface
{
     ...
     * @return void
     */
    public function __construct(DataSchema $schema, DataSchemaBlueprint $blueprint, MessageModel $messageModel)
    {
        $this->schema = $schema;
        $this->blueprint = $blueprint;
        $this->projectModel = $messageModel;
    }
