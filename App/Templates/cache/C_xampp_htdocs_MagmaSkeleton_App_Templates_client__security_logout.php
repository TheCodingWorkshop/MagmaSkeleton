...
<head>
    <meta charset="utf-8">
    <title> <?php echo htmlentities($locale['logout']['page_title'], ENT_QUOTES, 'UTF-8') ?> </title>
                        ...
                        <div class="col-lg-6">
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4"><?php echo htmlentities($locale['logout']['page_title'], ENT_QUOTES, 'UTF-8') ?></h1>
                                    <p><?php echo htmlentities($locale['logout']['page_content'], ENT_QUOTES, 'UTF-8') ?></p>
                                </div>
                                <?php echo $form ?> or
                                <a href="/profile/account/index" class="uk-button uk-button-text uk-text-primary">Cancel</a>.
